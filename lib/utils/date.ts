// Consistent date formatting functions to prevent hydration mismatch

/**
 * Format date in DD/MM/YYYY format (consistent across server and client)
 */
...
/**
 * Format current date for "Last updated" sections
 */
