...
def process_clean_images(source_dir, dest_dir, file_list, watermark_path, max_dimension=1920, quality=80, opacity=0.44, size_percentage=20):
...
if __name__ == '__main__':
    ...
    dest = "C:\\Users\\IT_COMMS\\Pictures\\New folder\\Ikara_Clean_Processed"
    ...
    process_clean_images(source, dest, images, watermark)
